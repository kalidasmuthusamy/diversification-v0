        ...
        return (
          <>
            ...
            <div>
              ...
              <div className="font-medium">{stockData.aum || stockData.marketCap}</div>
            </div>
          </>
        )
      case "Cryptocurrency":
          ...
          <section id="overview">
            <Card>
              ...
              <CardContent>
                ...
                {stockData.securityType !== "Cryptocurrency" && (
                  <div className="border-t pt-4">
                    <h4 className="font-medium mb-3">
                      {stockData.securityType === "ETF" ? "Fund Information" : "Company Information"}
                    </h4>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant="outline">{stockData.macroFactors.dollarStrength}</Badge>
                    </div>
                    <div className="flex justify-between items-center">
