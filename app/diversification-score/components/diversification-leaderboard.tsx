  ...
  weekly: [
    {
      ...
      date: "May 12, 2025",
      portfolio: "60+ holdings across 12 asset classes",
    },
    {
      rank: 2,
      score: 92,
      ...
      date: "May 13, 2025",
      portfolio: "ETF-focused with alternatives",
    },
    {
      rank: 3,
      score: 91,
      ...
      date: "May 10, 2025",
      portfolio: "International focus with 15+ countries",
    },
    { rank: 4, score: 89, username: "RiskParity", date: "May 11, 2025", portfolio: "Equal risk contribution model" },
    {
      rank: 5,
      score: 88,
      username: "AllWeatherPro",
      date: "May 14, 2025",
      portfolio: "Bridgewater-inspired allocation",
    },
  ],
  monthly: [
    {
      ...
      date: "May 2, 2025",
      portfolio: "Factor-based with 20+ uncorrelated assets",
    },
    {
      rank: 2,
      score: 95,
      ...
      date: "April 28, 2025",
      portfolio: "Multi-asset with commodities & REITs",
    },
    {
      rank: 3,
      score: 94,
    ...
    },
    {
      ...
      date: "April 30, 2025",
      portfolio: "Tactical allocation strategy",
    },
    {
      rank: 5,
      score: 92,
  ...
  allTime: [
    {
      ...
      date: "March 15, 2025",
      portfolio: "Perfect balance across all asset classes",
    },
    {
      rank: 2,
      score: 97,
...
export function DiversificationLeaderboard() {
      ...
      <CardHeader className="pb-3 bg-gradient-to-r from-amber-50 to-yellow-100">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-xl">America's Most Diverse Portfolios</CardTitle>
          </div>
