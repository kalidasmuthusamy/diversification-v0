          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-muted/30 p-3 rounded-lg">
                ...
                <div className="text-xl font-bold text-green-600">+3.5%</div>
              </div>
              <div className="bg-muted/30 p-3 rounded-lg">
                <div className="text-xs text-muted-foreground">1-Year Return</div>
                <div className="text-xl font-bold text-green-600">+5.2%</div>
              </div>
              <div className="bg-muted/30 p-3 rounded-lg">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Bonds have experienced moderate volatility as central banks navigate inflation concerns and economic
                    growth. Treasury yields have stabilized after a period of fluctuation, while corporate bonds
                    continue to offer attractive yields for investors seeking income. The inverted yield curve has
                    normalized somewhat, suggesting changing market expectations about future economic conditions.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-muted/30 p-3 rounded-lg">
                    ...
                    <div className="text-xl font-bold">$128T</div>
                  </div>
                  <div className="bg-muted/30 p-3 rounded-lg">
              ...
              <div className="space-y-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="p-4 border rounded-lg hover:bg-muted/30 transition-colors">
                    <h4 className="font-medium mb-1">Latest developments in Bond Markets</h4>
                    ...
                    <p className="text-sm">
                      This article discusses recent yield movements and factors affecting fixed income markets.
                    </p>
                  </div>
                ))}
              </div>
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                "Bonds continue to play a crucial role in portfolio construction, providing income and stability.
                Consider a mix of government, corporate, and inflation-protected securities for optimal
                diversification."
              </p>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Fixed Income Strategist, Global Predictions</div>
                </div>
              </div>
            </CardContent>
          </Card>
