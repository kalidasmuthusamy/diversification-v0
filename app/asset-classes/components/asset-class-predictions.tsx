        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-medium">Asset Class Forecasts</h3>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Int'l Stocks</span>
                </div>
                <Badge variant="outline" className="text-green-600 border-green-600">
                  <ArrowUp className="h-3 w-3 mr-0.5" />
                  10-12%
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="text-sm font-medium">Geopolitical Tensions</div>
                <div className="text-xs text-muted-foreground">Ongoing conflicts may impact energy markets</div>
              </div>
              <div>
                <div className="text-sm font-medium">Regulatory Changes</div>
                <div className="text-xs text-muted-foreground">New financial regulations expected in H2 2025</div>
              </div>
            </div>
          </div>
        </div>
